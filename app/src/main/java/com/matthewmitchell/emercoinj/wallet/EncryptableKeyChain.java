...
import com.matthewmitchell.emercoinj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link com.matthewmitchell.emercoinj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link com.matthewmitchell.emercoinj.core.Wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
