...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link com.matthewmitchell.emercoinj.core.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the emercoinj protobuf format. */
