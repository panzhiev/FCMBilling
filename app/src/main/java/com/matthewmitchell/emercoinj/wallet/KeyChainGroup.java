...
import com.matthewmitchell.emercoinj.crypto.ChildNumber;
import com.matthewmitchell.emercoinj.crypto.DeterministicKey;
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws com.matthewmitchell.emercoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.matthewmitchell.emercoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.matthewmitchell.emercoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
