...
import com.matthewmitchell.emercoinj.crypto.DRMWorkaround;
import com.matthewmitchell.emercoinj.net.BlockingClientManager;
import com.matthewmitchell.emercoinj.net.ClientConnectionManager;
import com.matthewmitchell.emercoinj.net.FilterMerger;
import com.matthewmitchell.emercoinj.net.NioClientManager;
import com.matthewmitchell.emercoinj.net.discovery.PeerDiscovery;
import com.matthewmitchell.emercoinj.net.discovery.PeerDiscoveryException;
import com.matthewmitchell.emercoinj.net.discovery.TorDiscovery;
import com.matthewmitchell.emercoinj.script.Script;
import com.matthewmitchell.emercoinj.utils.ExponentialBackoff;
 ...
 * you must call the {@link Service#start()} method (which returns
 * a future) or {@link Service#startAndWait()} method, which will block
 * until peer discovery is completed and some outbound connections have been initiated (it will return
 * before handshaking is done, however). You should call {@link Service#stop()}
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    /**
     * Same as {@link PeerGroup#addEventListener(PeerEventListener, Executor)} but defaults
    ...
    /**
     * Returns the {@link TorClient} object for this peer group, if Tor is in use, null otherwise.
     */
    @Nullable
