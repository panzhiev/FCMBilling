 ...
 * the lightweight SPV mode, a {@link com.matthewmitchell.emercoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.matthewmitchell.emercoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
