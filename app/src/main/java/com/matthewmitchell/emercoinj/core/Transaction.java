...
import com.matthewmitchell.emercoinj.script.ScriptOpCodes;
...
import static com.matthewmitchell.emercoinj.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Constructor for creation the transaction with specific version. Can be used for Nvs Record creation
     */
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.matthewmitchell.emercoinj.script.Script, ECKey, SigHash, boolean)}
    ...
    /**
     * set version for current tx. Can be 1638 for Nvs Record transaction
     */
