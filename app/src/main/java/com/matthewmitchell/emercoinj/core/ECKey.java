...
import com.matthewmitchell.emercoinj.crypto.NativeSecp256k1;
...
public class ECKey implements EncryptableItem, Serializable {
     ...
     * the {@link com.matthewmitchell.emercoinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
