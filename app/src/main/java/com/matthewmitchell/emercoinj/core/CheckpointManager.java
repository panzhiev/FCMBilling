...
import com.matthewmitchell.emercoinj.store.FullPrunedBlockStore;
 ...
 * {@link com.matthewmitchell.emercoinj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
