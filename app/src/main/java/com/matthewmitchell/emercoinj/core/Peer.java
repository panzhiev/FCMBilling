...
import com.matthewmitchell.emercoinj.net.AbstractTimeoutHandler;
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.matthewmitchell.emercoinj.net.NioClientManager#openConnection(java.net.SocketAddress, com.matthewmitchell.emercoinj.net.StreamParser)}
     * or
     * {@link com.matthewmitchell.emercoinj.net.NioClient#NioClient(java.net.SocketAddress, com.matthewmitchell.emercoinj.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // emercoinj is a client mode implementation. That means there's not much point in us talking to other client
