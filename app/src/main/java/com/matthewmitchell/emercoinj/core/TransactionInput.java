...
import com.matthewmitchell.emercoinj.wallet.DefaultRiskAnalysis;
...
public class TransactionInput extends ChildMessage implements Serializable {
     ...
     * @see TransactionOutPoint#getConnectedRedeemData(com.matthewmitchell.emercoinj.wallet.KeyBag)
     */
    @Nullable
