...
import com.matthewmitchell.emercoinj.protocols.payments.Protos.PaymentDetails;
import com.matthewmitchell.emercoinj.core.TransactionConfidence.ConfidenceType;
import com.matthewmitchell.emercoinj.crypto.*;
import com.matthewmitchell.emercoinj.params.UnitTestParams;
import com.matthewmitchell.emercoinj.script.Script;
import com.matthewmitchell.emercoinj.script.ScriptBuilder;
import com.matthewmitchell.emercoinj.script.ScriptChunk;
import com.matthewmitchell.emercoinj.signers.LocalTransactionSigner;
import com.matthewmitchell.emercoinj.signers.MissingSigResolutionSigner;
import com.matthewmitchell.emercoinj.signers.TransactionSigner;
import com.matthewmitchell.emercoinj.store.UnreadableWalletException;
import com.matthewmitchell.emercoinj.store.WalletProtobufSerializer;
import com.matthewmitchell.emercoinj.utils.BaseTaggableObject;
import com.matthewmitchell.emercoinj.utils.ExchangeRate;
import com.matthewmitchell.emercoinj.utils.ListenerRegistration;
import com.matthewmitchell.emercoinj.utils.Threading;
import com.matthewmitchell.emercoinj.wallet.*;
import com.matthewmitchell.emercoinj.wallet.Protos.Wallet.EncryptionType;
import com.matthewmitchell.emercoinj.wallet.WalletTransaction.Pool;
 ...
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of emercoinj,
 ...
 * {@link Wallet#autosaveToFile(File, long, TimeUnit, com.matthewmitchell.emercoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * This value is either directly specified during the marriage (see {@link #addFollowingAccountKeys(List, int)})
     ...
     * {@link com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.matthewmitchell.emercoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.emercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of emercoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(File, long, TimeUnit, com.matthewmitchell.emercoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.matthewmitchell.emercoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.matthewmitchell.emercoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.matthewmitchell.emercoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.matthewmitchell.emercoinj.crypto.KeyCrypter,
     ...
     * {@link com.matthewmitchell.emercoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * you can use {@link com.matthewmitchell.emercoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.matthewmitchell.emercoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
        ...
        /**
         * If not null, the {@link com.matthewmitchell.emercoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.matthewmitchell.emercoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws com.matthewmitchell.emercoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link com.matthewmitchell.emercoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
