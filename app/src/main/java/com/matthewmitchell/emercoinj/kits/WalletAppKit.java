...
package com.matthewmitchell.emercoinj.kits;

import com.matthewmitchell.emercoinj.core.*;
import com.matthewmitchell.emercoinj.net.discovery.DnsDiscovery;
import com.matthewmitchell.emercoinj.protocols.channels.StoredPaymentChannelClientStates;
import com.matthewmitchell.emercoinj.protocols.channels.StoredPaymentChannelServerStates;
import com.matthewmitchell.emercoinj.store.BlockStoreException;
import com.matthewmitchell.emercoinj.store.SPVBlockStore;
...
import com.matthewmitchell.emercoinj.wallet.DeterministicSeed;
import com.matthewmitchell.emercoinj.wallet.KeyChainGroup;
import com.google.common.collect.ImmutableList;
import com.google.common.util.concurrent.AbstractIdleService;
import com.google.common.util.concurrent.MoreExecutors;
import com.google.common.util.concurrent.Service;
import com.subgraph.orchid.TorClient;
import com.matthewmitchell.emercoinj.wallet.Protos;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV emercoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit emercoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing emercoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the emercoinj website for further details.
     */
