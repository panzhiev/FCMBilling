...
package com.matthewmitchell.emercoinj.net.discovery;

import com.matthewmitchell.emercoinj.core.AddressFormatException;
import com.matthewmitchell.emercoinj.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // emercoinj but not match the standard nick format, so full peers don't try and connect to us.
