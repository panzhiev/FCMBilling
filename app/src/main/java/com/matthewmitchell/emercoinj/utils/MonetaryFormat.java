...
import com.matthewmitchell.emercoinj.core.Monetary;
import com.matthewmitchell.emercoinj.shapeshift.ShapeShiftMonetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable fiat value to a {@link com.matthewmitchell.emercoinj.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
    ...
    /**
     * Gets a {@link com.matthewmitchell.emercoinj.shapeshift.ShapeShiftMonetary} for a string formatted with the MonetaryFormat
     *
