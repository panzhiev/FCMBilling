...
import com.matthewmitchell.emercoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     *                   See {@link com.matthewmitchell.emercoinj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
     * @param conn A callback listener which represents the connection to the server (forwards messages we generate to
     *             the server)
     */
